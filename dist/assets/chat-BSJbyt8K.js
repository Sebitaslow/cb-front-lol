import{p as C}from"./main-BqgEogXV.js";const x="https://cb-back-p.vercel.app",g=`${x}/chat`;function I(){console.log("🚀 Inicializando chat...");const l=document.getElementById("messages"),c=document.getElementById("input"),r=document.getElementById("send-btn"),y=document.getElementById("form");if(console.log("🔍 Elementos del chat encontrados:",{messagesContainer:!!l,input:!!c,sendBtn:!!r,form:!!y}),!l||!c||!r){console.warn("❌ Chat elements not found");return}function m(){l.innerHTML="",i("¡Hola! Soy tu asistente de IA especializado en desarrollo de software. ¿En qué puedo ayudarte con este video?","bot")}function h(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function v(t){let e=t;return e=e.replace(/```(\w+)?\n([\s\S]*?)```/g,(o,s,n)=>`<div class="code-block">
